...
with open('dictionary_words.json') as dict_readerold:
        #print("Dictionary is red..............0")
        #print(json.load(dict_reader))
        #print('......................1')
        oldWords=json.load(dict_readerold)
with open('HighFrequency_words_vocab.json') as dict_reader:
        #print("Dictionary is red..............0")
        #print(json.load(dict_reader))
        #print('......................1')
        newWords=json.load(dict_reader)
        #print('......................2')
        oldWords.update(newWords)
