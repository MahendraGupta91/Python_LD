...
def get_word(E_word):
         if E_word.get():
            ...
            #h2=tk.Frame(root,height=50,width=200,bg='#1A5266').grid(column=0,row=0)
            tk.Label(root,text="Type the word",fg="red",bg='#1A5266').grid(column=0,row=0)
...
h=tk.Frame(root,height=10,width=200,bg='#1A5266').grid(column=0,row=0)
